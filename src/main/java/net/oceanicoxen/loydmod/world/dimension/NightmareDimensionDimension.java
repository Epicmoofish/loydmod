...
public class NightmareDimensionDimension extends LoydmodModElements.ModElement {
	public NightmareDimensionDimension(LoydmodModElements instance) {
		super(instance, 109);
	}
	...
	public void clientLoad(FMLClientSetupEvent event) {
		...
		DeferredWorkQueue.runLater(() -> {
			try {
				...
				effectsRegistry.put(new ResourceLocation("loydmod:nightmare_dimension"), customEffect);
			} catch (Exception e) {
				e.printStackTrace();
			}
		});
