...
public class DreamFenceBlock extends LoydmodModElements.ModElement {
	@ObjectHolder("loydmod:dream_fence")
	public static final Block block = null;
	public DreamFenceBlock(LoydmodModElements instance) {
		super(instance, 7);
	}
