...
public class NightmarishPlanksBlock extends LoydmodModElements.ModElement {
	@ObjectHolder("loydmod:nightmarish_planks")
	public static final Block block = null;
	public NightmarishPlanksBlock(LoydmodModElements instance) {
		super(instance, 88);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("nightmarish_planks");
		}
