...
public class NightmarishStairsBlock extends LoydmodModElements.ModElement {
	@ObjectHolder("loydmod:nightmarish_stairs")
	public static final Block block = null;
	public NightmarishStairsBlock(LoydmodModElements instance) {
		super(instance, 90);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("nightmarish_stairs");
		}
