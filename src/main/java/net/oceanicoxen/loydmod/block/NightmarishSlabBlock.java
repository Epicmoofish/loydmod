...
public class NightmarishSlabBlock extends LoydmodModElements.ModElement {
	@ObjectHolder("loydmod:nightmarish_slab")
	public static final Block block = null;
	public NightmarishSlabBlock(LoydmodModElements instance) {
		super(instance, 91);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("nightmarish_slab");
		}
