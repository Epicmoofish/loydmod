...
public class NightmareWoodBlock extends LoydmodModElements.ModElement {
	@ObjectHolder("loydmod:nightmare_wood")
	public static final Block block = null;
	public NightmareWoodBlock(LoydmodModElements instance) {
		super(instance, 1);
	}
