...
public class NightmarishFenceBlock extends LoydmodModElements.ModElement {
	@ObjectHolder("loydmod:nightmarish_fence")
	public static final Block block = null;
	public NightmarishFenceBlock(LoydmodModElements instance) {
		super(instance, 92);
	}
	...
	public static class CustomBlock extends FenceBlock {
		public CustomBlock() {
			...
			setRegistryName("nightmarish_fence");
		}
