...
public class NightmareStoneBlock extends LoydmodModElements.ModElement {
	@ObjectHolder("loydmod:nightmare_stone")
	public static final Block block = null;
	public NightmareStoneBlock(LoydmodModElements instance) {
		super(instance, 121);
	}
