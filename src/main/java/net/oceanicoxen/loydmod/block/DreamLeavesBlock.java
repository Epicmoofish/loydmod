...
public class DreamLeavesBlock extends LoydmodModElements.ModElement {
	@ObjectHolder("loydmod:dream_leaves")
	public static final Block block = null;
	public DreamLeavesBlock(LoydmodModElements instance) {
		super(instance, 4);
	}
