...
public class NightmarishFenceGateBlock extends LoydmodModElements.ModElement {
	@ObjectHolder("loydmod:nightmarish_fence_gate")
	public static final Block block = null;
	public NightmarishFenceGateBlock(LoydmodModElements instance) {
		super(instance, 93);
	}
	...
	public static class CustomBlock extends FenceGateBlock {
		public CustomBlock() {
			...
			setRegistryName("nightmarish_fence_gate");
		}
