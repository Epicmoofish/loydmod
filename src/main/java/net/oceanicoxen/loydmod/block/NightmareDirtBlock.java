...
public class NightmareDirtBlock extends LoydmodModElements.ModElement {
	@ObjectHolder("loydmod:nightmare_dirt")
	public static final Block block = null;
	public NightmareDirtBlock(LoydmodModElements instance) {
		super(instance, 36);
	}
