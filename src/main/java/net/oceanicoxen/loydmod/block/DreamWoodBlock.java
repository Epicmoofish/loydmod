...
public class DreamWoodBlock extends LoydmodModElements.ModElement {
	@ObjectHolder("loydmod:dream_wood")
	public static final Block block = null;
	public DreamWoodBlock(LoydmodModElements instance) {
		super(instance, 1);
	}
