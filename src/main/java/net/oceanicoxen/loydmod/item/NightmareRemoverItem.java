...
public class NightmareRemoverItem extends LoydmodModElements.ModElement {
	@ObjectHolder("loydmod:nightmare_remover")
	public static final Item block = null;
	public NightmareRemoverItem(LoydmodModElements instance) {
		super(instance, 104);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("nightmare_remover");
		}
