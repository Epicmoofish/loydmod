...
import net.oceanicoxen.loydmod.gui.DreamItemsHolderGUIGuiWindow;
import net.oceanicoxen.loydmod.gui.DreamItemsHolderGUIGui;
...
public class DreamHolderItem extends LoydmodModElements.ModElement {
	@ObjectHolder("loydmod:dream_holder")
	public static final Item block = null;
	public DreamHolderItem(LoydmodModElements instance) {
		super(instance, 59);
	...
	public void onItemDropped(ItemTossEvent event) {
		if (event.getEntityItem().getItem().getItem() == block) {
			if (Minecraft.getInstance().currentScreen instanceof DreamItemsHolderGUIGuiWindow) {
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Dream Holder");
					}
					...
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						...
						return new DreamItemsHolderGUIGui.GuiContainerMod(id, inventory, packetBuffer);
					}
				}, buf -> {
