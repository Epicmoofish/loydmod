...
public class DreamStaffItem extends LoydmodModElements.ModElement {
	@ObjectHolder("loydmod:dream_staff")
	public static final Item block = null;
	@ObjectHolder("loydmod:entitybulletdream_staff")
	public static final EntityType arrow = null;
	public DreamStaffItem(LoydmodModElements instance) {
		super(instance, 50);
	}
	...
	public void initElements() {
		...
		elements.entities.add(() -> (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
				...
				.size(0.5f, 0.5f)).build("entitybulletdream_staff").setRegistryName("entitybulletdream_staff"));
	}
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		public ItemStack getItem() {
			return new ItemStack(DreamgemItem.block, (int) (1));
		}
